---
name: Arms · Biceps, Triceps & Grip
active: false
---

An ACCESSORY plan, not a week. It has no weekday — start it from the Plans
page on a day that has room, or bolt the finisher onto the end of a pull or
push session. Two or three arm sessions a week is already plenty of direct
work when you are also doing pull-ups and dips.

Arms grow from the compounds first and the isolation second, so nothing here
...
Chin-ups and dips carry the load; everything after them is the direct work.
Rest ~90s after the first two, ~60s after the rest. Superset a curl with an
extension if you are short on time — they do not compete.

- Chin-ups | 4 x 5-8
- Straight-bar Dips | 4 x 6-10
- Dumbbell Curl | 3 x 8-12
- Overhead Triceps Extension | 3 x 10-12
- Hammer Curls | 3 x 10-12
- Close-grip Push-ups | 2 x 10-15
- Farmer's Carry | 2 x 40s
- Dead Hang | 2 x 30-45s

## Arms · 12-minute Finisher (any)

For the end of a pull or push day. Short rests, strict form, stop two reps
short — this is volume, not a test.
